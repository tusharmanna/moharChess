...
export const metadata = generateMeta({
  title: "March Chess Tournaments - USCF Rated Scholastic Competitions",
  description: "Join our USCF-rated scholastic chess tournaments in March. 4-round Swiss system with sections for all skill levels. Located in Roswell, GA. Tournament preparation and competitive chess.",
  keywords: "uscf tournament, chess tournament, scholastic chess, rated chess tournament, georgia chess tournament, youth chess competition, march tournament",
  ogImage: "/images/rated-banner.jpg"
});

export default function MarchTournaments() {
  return (
