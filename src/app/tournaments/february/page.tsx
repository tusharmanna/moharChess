...
export const metadata = generateMeta({
  title: "February Chess Tournaments - USCF Rated Scholastic Competitions",
  description: "Join our USCF-rated scholastic chess tournaments in February. 4-round Swiss system with sections for all skill levels. Located in Roswell, GA. Tournament preparation and competitive chess.",
  keywords: "uscf tournament, chess tournament, scholastic chess, rated chess tournament, georgia chess tournament, youth chess competition, february tournament",
  ogImage: "/images/rated-banner.jpg"
});

export default function FebruaryTournaments() {
  return (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-teal-50 p-6 rounded-lg border border-teal-200">
                  ...
                  <div className="space-y-3 text-gray-700">
                    <p>
                      <strong>Date:</strong> Feb 21, 2026 (Saturday)
                    </p>
                    <p>
